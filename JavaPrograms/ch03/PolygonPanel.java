...
public class PolygonPanel extends JPanel
{
	...
	public void paintComponent (Graphics g)
	{
		...
		g.drawString("Polygons Rule", getWidth()/2, getHeight()/2);
		...
		int[] xvalues = {600, 650, 700};
		int [] yvalues = {500, 650, 500};
		...
		int [] xvaluessquare = {450, 450, 750, 750};
		int [] yvaluessquare = {200, 300, 300, 200};
		g.fillPolygon(xvaluessquare, yvaluessquare, 4);
		...
		g.setColor(brown);
		int [] xvaluespentagon = {200, 400, 500, 300, 100};
		int [] yvaluespentagon = {600, 600, 500, 200, 500};
		g.fillPolygon(xvaluespentagon, yvaluespentagon, 5);
		...
		int [] xvalueshexagon = {800, 850, 900, 950, 900, 850};
		int [] yvalueshexagon = {500, 400, 400, 500, 600, 600};
		g.fillPolygon (xvalueshexagon, yvalueshexagon, 6);
		...
		int [] xvaluesoctagon = {50, 50, 100, 150, 200, 200, 150, 100};
		int [] yvaluesoctagon = {220, 170, 130, 130, 170, 220, 260, 260};
		g.fillPolygon(xvaluesoctagon, yvaluesoctagon, 8);
