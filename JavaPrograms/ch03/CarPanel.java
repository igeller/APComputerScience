...
public class CarPanel extends JPanel
{
	...
	public void paintBody(Graphics g)
	{
		...
		//g.fillOval(200, 200, 600, 200);
		g.fillRoundRect(200, 200, 600, 200, 100, 200);
		
		
		
		// Paint the convertible cut out gray by painting a rounded-rectangle.
		g.setColor(Color.gray);
		g.fillRoundRect(360, 200, 300, 10, 5, 5);
	
		
		// Paint the border of the convertible cut out black by drawing a rounded-rectangle.
		g.setColor(Color.black);
		g.drawRoundRect(360, 200, 300, 10, 5, 5);
		
		
		// Erase the top part of the border of the convertible cut out gray.
		g.setColor(Color.GRAY);
		g.drawLine(360, 200, 655, 200);
		
		
		// Draw a black outline for the door.
		g.setColor(Color.black);
		g.drawRoundRect(400, 200, 220, 140, 10, 100);
		g.setColor(Color.gray); //to cover the door which was made to start at the y point of the top of the car
		g.drawLine(400, 200, 660, 200);//to cover the door which was made to start at the y point of the top of the car
		g.fillRoundRect(360, 200, 300, 10, 5, 5); //to cover the door which was made to start at the y point of the top of the car
		
		
		// Draw the black door knob.
		g.setColor(Color.black);
		g.fillOval(490, 240, 10, 10);
		//g.fillOval(635, 250, 10, 10);

		
		// Draw the black pen stripe.
		g.fillRect(200, 300, 600, 5);
		
		
		// Draw the black "Go Cards" logo (or other logo) on the body just
		// above the pen stripe at the back of the car.
		g.drawString("Go Cards", 725, 295);
		
		
		// Paint the light gray wind shield using an arc.
		g.setColor(Color.lightGray);
		g.fillArc(260, 150, 280, 125, -180, -110 );
		
		
		// Draw the black border of the wind shield.
		g.setColor(Color.black);
		g.drawArc(260, 150, 280, 125, -180, -110 );
		
		
		// Draw the car's antenna black and the ball at the top of the antenna red.
		g.drawLine(725, 100, 725, 200);
		g.setColor(Color.red);
		g.fillOval(720, 95, 10, 10);
		
		
		// Draw two black lines to represent the steering wheel column (shaft).
		g.setColor(Color.black);
		g.drawLine(400, 210, 450, 190);
		g.drawLine(405, 210, 450, 190);

		
		// Draw a black circle to represent the steering wheel.
		g.drawOval(445, 175, 20, 20);

		
		
		// Draw a black vertical and a black horizontal line for the spokes on
		// the steering wheel.
		g.drawLine(455, 175, 455, 195);
		g.drawLine(445, 185, 465, 185);
	...
	{
		g.setColor(Color.black);
		g.fillOval(250, 320, 150, 150);
		
		g.setColor(Color.lightGray);
		g.fillOval(275, 345, 100, 100);
		
		g.setColor(Color.black);
		g.drawLine(275, 395, 375, 395);
		g.drawLine(325, 345, 325, 445);
		g.drawLine(275, 345, 375, 445);
		g.drawLine(375, 345, 275, 445);
	...
	{
		g.setColor(Color.black);
		g.fillOval(600, 320, 150, 150);
		
		g.setColor(Color.lightGray);
		g.fillOval(625, 345, 100, 100);
		
		g.setColor(Color.black);
		g.drawLine(625, 395, 725, 395);
		g.drawLine(675, 345, 675, 445);
		g.drawLine(625, 345, 725, 445);
		g.drawLine(725, 345, 625, 445);
